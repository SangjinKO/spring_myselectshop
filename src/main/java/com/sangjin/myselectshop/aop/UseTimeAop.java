...
import com.sangjin.myselectshop.repository.ApiUseTimeRepository;
...
public class UseTimeAop {
    ...
    @Pointcut("execution(* com.sangjin.myselectshop.controller.ProductController.*(..))")
    private void product() {}
    @Pointcut("execution(* com.sangjin.myselectshop.controller.FolderController.*(..))")
    private void folder() {}
    @Pointcut("execution(* com.sangjin.myselectshop.naver.controller.NaverApiController.*(..))")
    private void naver() {}
